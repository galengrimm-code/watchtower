...
|---|---|---|
| Scan prompt | 2,000+ lines of "what to check, what to flag," currently at v7.5 with OWASP Top 10 (2021) categorization, reachability-tiered dependency-CVE severity, script-measured standards compliance, per-app strengths, and silent-failure / memory-growth sweeps | `prompts/security-scan-prompt.md` |
